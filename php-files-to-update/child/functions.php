...
function add_header_items() {
	echo "<div id=\"hdr-aux\">";
	echo "<div id=\"hdr-addy\"><strong>540-745-4428</strong><br />585 Floyd Hwy<br />Floyd VA, 24091</div>";
...
function childtheme_override_postheader_postmeta() {
 ...
 function add_footer() {
  	echo "<div id=\"nav-social\"><a href=\"https://www.facebook.com/pages/The-Pine-Tavern-Lodge/104955589547465\"><img src=\"".get_stylesheet_directory_uri()."/images/facebook.png\" alt=\"Pine Tavern Lodge on Facebook\" /></a></div>";
...
// TribleWork, removed <img>
    return '<script>,<style>,<br>,<em>,<i>,<ul>,<ol>,<li>,<a>,<p>,<video>,<audio>,,<pre>,<blockquote>';
}
...
function tw_enqueue_styles() {
    ...
    $parent_style = 'vendd-style'; // This is 'twentyfifteen-style' for the Twenty Fifteen theme.

    wp_enqueue_style( 'tw-style',
        get_stylesheet_directory_uri() . '/tw-style.css',
        '',
        time()
    );
}
